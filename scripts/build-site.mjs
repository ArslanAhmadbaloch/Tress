...
const home = shell({
  ...
  body: `  <div class="hero">
    ...
    <p class="lede">A haircare journal. Scan your hair on your phone over time, write a
    line beside each scan, and keep track of what you are actually using.</p>
  </div>

  <h2>What it does</h2>
  <ul class="cards">
    <li><b>One scan, the same angles every time</b><span>Turn your head and Tress
    captures the important angles on its own, so what you compare next month is your
    hair rather than where you happened to stand.</span></li>
    ...
    <li><b>A line beside every scan</b><span>What you changed, how the month went. The
